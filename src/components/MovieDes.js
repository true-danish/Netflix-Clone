    ...
    <div className="text-white inset-0 bg-black/20 absolute pl-14 flex justify-center -mt-8  md:justify-center items-start  flex-col ">
      ...
      /> */}
        ...
        <div className="flex gap-4 flex-wrap lg:text-xl ">
          <button className="bg-white text-black hover:bg-slate-300 rounded-md py-3 px-8 max-sm:p-2 flex items-center  gap-3">
            <i className="fa-solid fa-play"></i>
            Play
          </button>
          <button className="bg-slate-800 hover:bg-slate-600 rounded-md py-3 px-8 max-sm:p-2 flex gap-2 items-center">
